...
#define sensor_SCL A0
#define sensor_SDA A1
#define int_pin 1

float position_vec[]={1,2,3};
float angle_vec[]={4,5,6};
...
void setup_sensor() {
  ...
  Roll_bias /=2000; // Dela med 2000 för medelvärde
  Pitch_bias/=2000;
  Yaw_bias  /=2000;  
  //AccX_bias /=2000;
  //AccY_bias /=2000;
...
void read_sensor(){
  ...
  */
  ...
  const float meters2_to_mms2=10000;
  position_vec[0]=AccX*meters2_to_mms2;
  position_vec[1]=AccY*meters2_to_mms2;
  position_vec[2]=AccZ*meters2_to_mms2;
